...
/**
 * This class represents a single ResultSetRow, as produced by the ResultSet Class.
 */
class ResultSetRow extends Object {
	 ...
	 */
	public function __construct( ResultSet $rs=null ) {
		$this->rs = $rs;
	}
